...
class Trabajo extends Conectar
{
    ...
    public function add_trabajo($nombreTrabajo, $descripcionTrabajo, $fechaEstimadaT, $fechaRealT, $estadoT, $costoT, $horasT, $cOrdenTrabajo, $cTipoT, $cEmpleado)
    {
        $conectar = parent::conexion();
        $sql = "INSERT INTO trabajo VALUES(null, ?, ?, ?, ?, ?, ?, ?, null, null, null)";
        $sql = $conectar->prepare($sql);
