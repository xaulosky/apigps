...
switch ($method) {
    ...
    case 'POST':
        ...
        break;
    case 'PUT':
        $empleado->crear_empleado($body['cEmpleado'],$body['rutEmpleado'], $body['nombreEmpleado'], $body['apellidoEmpleado'], $body['emailEmpleado'], $body['numeroTelefonoEmpleado'], $body['cRolE'], $body['cTaller']);
        break;
        case 'DELETE':
